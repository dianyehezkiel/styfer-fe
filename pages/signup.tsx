...
const SignUp: NextPage = () => {
  return (
    <div className="sm:container min-h-screen mx-auto flex flex-col gap-16 items-center py-12 px-4">
      <Head>
        <title>Styfer | Sign up</title>
        <meta name="description" content="Sign up to Styfer" />
      ...
      <div className="flex flex-col gap-4 w-full px-4">
        <p className="font-bold text-center mb-2">Create your account</p>
        <form className="form-control flex flex-col gap-4">
          <label className="relative label p-0">
            <span className="label-text hidden">Username</span>
            <input
              name="username"
              type="text"
          ...
          <label className="relative label p-0">
            <span className="label-text hidden">Email</span>
            <input
              name="email"
              type="email"
              ...
              className="input input-lg input-bordered w-full rounded-full pl-12"
            />
            <EnvelopeIcon className="absolute left-4 top-5 w-6 h-6 fill-neutral/60" />
          </label>
          <label className="relative label p-0">
